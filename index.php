            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        ...
                        <a href="<?php echo $url; ?>/usuarios/nuevoUsuario.php">
                            <div class="icon">
                                <i class="fas fa-user-plus"></i>
                            </div>
                        </a>
                        <a href="<?php echo $url; ?>/usuarios/listarUsuarios.php" class="small-box-footer">Mas info <i
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-info">
                        ...
                        <a href="<?php echo $url; ?>/doctores/listarDoctores.php">
                            <div class="icon">
                                <i class="fa-solid fa-user-doctor"></i>
                            </div>
                        </a>
                        <a href="<?php echo $url; ?>/doctores/listarDoctores.php" class="small-box-footer">Mas info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!--card records-->
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-success">
                        ...
                        <a href="<?php echo $url; ?>/records/listar.php">
                            <div class="icon">
                                <i class="fa-solid fa-list"></i>
                            </div>
                        </a>
                        <a href="<?php echo $url; ?>/records/listar.php" class="small-box-footer">Mas info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!--card citas-->
